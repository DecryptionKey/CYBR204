...
## _Asset Inventory._
> ```javascript
> "nmap -O 172.20,21,22,30,31,40.0.0/24"
> ```
> _The command used in Nmap to perform a network and OS discovery to identify the Host, IP addresses, and OS Versions._

## _Completed Asset Inventory w/ Scan Results._
